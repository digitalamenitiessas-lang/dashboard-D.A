 ...
 * Source artwork: public/icono.svg
 */
export function BrandMark({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 861.18 1128.66"
